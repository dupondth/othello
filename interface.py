...
class Ui_principale_ihm(object):
    def setupUi(self, principale_ihm):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(420, 30, 135, 321))
        ...
        self.niveau_ia1 = QtWidgets.QComboBox(self.layoutWidget)
        self.niveau_ia1.setObjectName("niveau_ia1")
        self.niveau_ia1.addItem("")
        self.niveau_ia1.addItem("")
        self.niveau_ia1.addItem("")
        self.niveau_ia1.addItem("")
        self.verticalLayout.addWidget(self.niveau_ia1)
        self.label_2 = QtWidgets.QLabel(self.layoutWidget)
        self.label_2.setObjectName("label_2")
        self.verticalLayout.addWidget(self.label_2)
        self.niveau_ia2 = QtWidgets.QComboBox(self.layoutWidget)
        self.niveau_ia2.setObjectName("niveau_ia2")
        self.niveau_ia2.addItem("")
        self.niveau_ia2.addItem("")
        self.niveau_ia2.addItem("")
        self.niveau_ia2.addItem("")
        self.verticalLayout.addWidget(self.niveau_ia2)
        spacerItem1 = QtWidgets.QSpacerItem(68, 58, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout.addItem(spacerItem1)
        self.bouton_simuler = QtWidgets.QPushButton(self.layoutWidget)
        self.bouton_simuler.setObjectName("bouton_simuler")
        self.verticalLayout.addWidget(self.bouton_simuler)
        ...
        spacerItem2 = QtWidgets.QSpacerItem(68, 58, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, principale_ihm):
        ...
        self.label.setText(_translate("principale_ihm", "Niveau IA 1 :"))
        self.niveau_ia1.setItemText(0, _translate("principale_ihm", "Facile"))
        self.niveau_ia1.setItemText(1, _translate("principale_ihm", "Normal"))
        self.niveau_ia1.setItemText(2, _translate("principale_ihm", "Difficile"))
        self.niveau_ia1.setItemText(3, _translate("principale_ihm", "Très difficile"))
        self.label_2.setText(_translate("principale_ihm", "Niveau IA 2 :"))
        self.niveau_ia2.setItemText(0, _translate("principale_ihm", "Facile"))
        self.niveau_ia2.setItemText(1, _translate("principale_ihm", "Normal"))
        self.niveau_ia2.setItemText(2, _translate("principale_ihm", "Difficile"))
        self.niveau_ia2.setItemText(3, _translate("principale_ihm", "Très difficile"))
        self.bouton_simuler.setText(_translate("principale_ihm", "Début simulation"))
